...
public class SacarFotos extends Activity {
    ...
    public void takePicture() {
        ...
        values.put(MediaStore.Images.Media.DATA,getExternalStorageDirectory()+"/Pictures/Dia"+Comgerfecha()+"Hora"+Calendar.getInstance().get(Calendar.HOUR_OF_DAY)+":"+Calendar.getInstance().get(Calendar.MINUTE)+".jpg");
